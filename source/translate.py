Language = {
    'EN' : {
        ...
        'Copying file: File name could not be displayed.' : 'Copying file: File name could not be displayed.',
        ...
        '_filesCopiedInfo' : '%d files copied with a total size of %s.',
    ...
    'NL' : {
        ...
        'Copying file: File name could not be displayed.' : 'Bestand kopiëren: bestandsnaam kan niet worden weergegeven.',
