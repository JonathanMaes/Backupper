  ...
  kids=[
    StringFileInfo(
      ...
      StringTable(
        ...
        StringStruct(u'FileDescription', u'Jonathan\'s Backupper'),
        StringStruct(u'FileVersion', open('./changelog.txt', 'r', encoding='utf-8').read().split('\n')[0]),
        StringStruct(u'InternalName', u'Jonathan\'s Backupper'),
        StringStruct(u'LegalCopyright', u'Copyright (C) 2018-2021 Jonathan Maes'),
        StringStruct(u'LegalTrademarks', u'Copyright (C) 2018-2021 Jonathan Maes'),
        StringStruct(u'OriginalFilename', u'main.exe'),
        StringStruct(u'ProductName', u'Jonathan\'s Backupper'),
